        ...
        <div class="darkback darkback_sities"><!--screen_off modal_off-->
            <div class="modal-window-sities modal-sities modal_block-sities"><!-- screen_off -->                
                <div class="modal-content">
                    <span class="modal_sity content_sity">Ваш город?</span>
                    <div class="modal_sity_block"></div>
                </div>
            </div>
        </div>        
        <!-- модальное окно выбора города -->
            ...
            <div class="logo-text-tel logo-text-tel_margin">
                <div class="logo-name">
                    ...
                    <p class="logo__subtitle">ремонт бытовой техники в <span class="sity__sity"></span></p>
                </div>
                <div class="tel">
                    ...
                    <div class="tel__number"><a class="tel__link" href="tel:+73432435451"><span class="sity__phone"></span></a></div>
