            ...
            <div class="modal-window modal-master screen_off">
                ...
                <div class="modal-content" id="master">
                    ...
                    <div class="modal_align">
                        <textarea class="modal-textarea defect" name="text" placeholder="Опишите, что случилось с {% if content.deviceId == 3 or content.deviceId == 4 %}вашим{% else %}вашей{% endif %} {{content.pageTitle4}}">{% if content.defectTableId == 2 %}{{ content.pageTitle }}{% endif %}</textarea>
